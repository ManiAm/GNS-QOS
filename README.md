...
- **[Beyond Standard DCQCN](docs/06_DCQCN_.md):** Next-generation congestion control — per-hop telemetry (INT and IFA), direct rate control (HPCC/HPCC++), Congestion Signaling (CSIG), and Programmable Congestion Control (PCC).
